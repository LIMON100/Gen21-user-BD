...
class BookingNew extends Model {
  ...
  BookingNew.fromJson(Map<String, dynamic> json) {
    ...
    is_reviewd = boolFromJson(json, 'is_reviewd');
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.acceptor_provider_id != null) {
      data['acceptor_provider_id'] = this.acceptor_provider_id;
    }
    if (this.is_reviewd != null) {
      data['is_reviewd'] = this.is_reviewd;
    }
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || super == other && other is BookingNew && runtimeType == other.runtimeType && id == other.id && hint == other.hint && cancel == other.cancel && duration == other.duration && quantity == other.quantity && status == other.status && user == other.user && eService == other.eService && eProvider == other.eProvider && options == other.options && taxes == other.taxes && address == other.address && coupon == other.coupon && bookingAt == other.bookingAt && startAt == other.startAt && endsAt == other.endsAt && payment == other.payment;

  @override
  int get hashCode => super.hashCode ^ id.hashCode ^ hint.hashCode ^ cancel.hashCode ^ duration.hashCode ^ quantity.hashCode ^ status.hashCode ^ user.hashCode ^ eService.hashCode ^ eProvider.hashCode ^ options.hashCode ^ taxes.hashCode ^ address.hashCode ^ coupon.hashCode ^ bookingAt.hashCode ^ startAt.hashCode ^ endsAt.hashCode ^ payment.hashCode;
}
...
class Options extends Model {
  ...
  Options({this.id, this.name, this.description, this.price, this.minimumUnit, this.eServiceId, this.optionGroupId});

  Options.fromJson(Map<String, dynamic> json) {
    id = stringFromJson(json, 'id');
    name = objectFromJson(json, 'name', (v) => Name.fromJson(v));
