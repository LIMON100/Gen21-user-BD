...
class Category extends Model {
  ...
  @override
  String toString() {
    return 'Category{id: $id, name: $name, description: $description, color: $color, image: $image, featured: $featured, subCategories: $subCategories, eServices: $eServices}';
  }
  ...
  Category.fromJson(Map<String, dynamic> json) {
    ...
    eServices = listFromJsonArray(json, ['e_services', 'featured_e_services'], (v) => EService.fromJson(v)).removeDuplicates();
