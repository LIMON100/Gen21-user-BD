...
class EProvider extends Model {
  ...
  @override
  String toString() {
    return 'EProvider{id: $id, name: $name, description: $description, images: $images, phoneNumber: $phoneNumber, mobileNumber: $mobileNumber, type: $type, availabilityHours: $availabilityHours, availabilityRange: $availabilityRange, available: $available, featured: $featured, addresses: $addresses, taxes: $taxes, employees: $employees, rate: $rate, reviews: $reviews, totalReviews: $totalReviews, verified: $verified, bookingsInProgress: $bookingsInProgress}';
  }
  ...
  EProvider.fromJson(Map<String, dynamic> json) {
    ...
    print("sjdnfjak stringFromJson(json, 'phone_number') ${stringFromJson(json, 'phone_number')}");
    ...
    reviews = listFromJson(json, 'review_lists', (v) => Review.fromJson(v));

    print("jsdfsdafdsba review in e_provider_model ${reviews.toString()}");
