...
class EService extends Model {
  ...
  @override
  String toString() {
    return 'EService{id: $id, name: $name, description: $description, images: $images, price: $price, discountPrice: $discountPrice, priceUnit: $priceUnit, quantityUnit: $quantityUnit, rate: $rate, totalReviews: $totalReviews, duration: $duration, featured: $featured, enableBooking: $enableBooking, isFavorite: $isFavorite, categories: $categories, subCategories: $subCategories, eProvider: $eProvider}';
  }

  EService.fromJson(Map<String, dynamic> json) {
    print("fsjfsddjdads91 json: ${json.toString()}  data: ${json['data']}");
