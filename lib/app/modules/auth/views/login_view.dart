                ...
                if (controller.loading.isTrue)
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Checkbox(
                              ...
                              value: controller.isTramsConditionChecked.value,
                              onChanged: (value) {
                                controller.isTramsConditionChecked.value = value;
                              }),
                          InkWell(
                            onTap: (){
                               Get.toNamed(Routes.CUSTOM_WEBVIEW, arguments: {
                                 "url": "gen21.com.au/terms", "title":"Terms & Conditions"
                               });
                            },
                            child: Container(
                      ...
                      //     bool hasSeenOnboarding = await GetStorage().read('hasSeenOnboarding') ?? false;
                      //
                      //     // Login the user
                      ...
                      //     } else {
                      //       Get.offAllNamed(OnboardingScreen() as String);
