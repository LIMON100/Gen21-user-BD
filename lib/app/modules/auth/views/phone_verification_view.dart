              ...
              Obx(() {
                if (controller.loading.isTrue) {
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        "We sent the OTP code to your ${Get.find<AuthService>().user.value.countryCode}${Get.find<AuthService>().user.value.phoneNumber} phone number, please check it and enter below".tr,
