        ...
        child: ExpansionTile(
          ...
          title: InkWell(
              ...
              onTap: () {
                ...
                Get.toNamed(Routes.SERVICE, arguments: {'category_id': category.id, 'heroTag': 'search_list'});
          ...
          children: List.generate(category.subCategories?.length ?? 0, (index) {
            ...
            return GestureDetector(
              onTap: () {
                print("KYToito: ${_category.toString()}");
                // Get.toNamed(Routes.CATEGORY, arguments: _category);
                // Get.toNamed(Routes.CATEGORY, arguments: {'category': _category, 'heroTag': 'recommended_carousel_item'});
                Get.toNamed(Routes.SERVICE, arguments: {'category_id': _category.id, 'heroTag': 'search_list'});
              },
              child: Container(
