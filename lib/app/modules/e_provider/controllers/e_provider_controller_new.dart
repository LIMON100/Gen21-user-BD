...
class EProviderControllerNew extends GetxController {
  ...
  void onInit() {
    ...
    print("KYToito argmnts EProviderController ${arguments.toString()}");
    // eProvider.value = arguments['eProvider'] as EProvider;
    eProvider.value.id = "${arguments['eProviderId']}";
