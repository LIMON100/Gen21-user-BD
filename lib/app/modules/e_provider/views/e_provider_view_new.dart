...
class EProviderViewNew extends GetView<EProviderControllerNew> {
  @override
                        ...
                        EProviderTilWidget(
                          ...
                          content: Column(
                            children: [
                              ...
                              Obx(() {
                                print("jsdfsdafdsba Reviews ${controller.eProvider.value.reviews.toString()}");
                                if (controller.eProvider.value.reviews.isEmpty) {
                                  return CircularLoadingWidget(height: 100);
                                }
                                return ListView.separated(
                                  padding: EdgeInsets.all(0),
                                  itemBuilder: (context, index) {
                                    return ReviewItemWidget(review: controller.eProvider.value.reviews.elementAt(index));
                                  },
                                  separatorBuilder: (context, index) {
                                    return Divider(height: 35, thickness: 1.3);
                                  },
                                  itemCount: controller.eProvider.value.reviews.length,
                                  primary: false,
                                  shrinkWrap: true,
                                );
                              }),
