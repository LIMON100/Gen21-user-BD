...
class ChatsView extends GetView<MessagesController> {
  ...
  Widget chatList() {
    return Obx(
      () {
        printWrapped("fndjknakjfndjs controller.chats.toString():  ${controller.chats.toString()}");
        if (controller.chats.isEmpty) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                printWrapped("sndfaksfs in chat view ${controller.message.value.users.toString()}");
                printWrapped("sndfaksfs in chat view ${controller.message.value.users.firstWhere((_user) => _user.id == _chat.userId, orElse: () => new User(name: "-", avatar: new Media()))}");
  ...
  Widget build(BuildContext context) {
    ...
    print("sndnfdsnjsd in build controller.message.value: ${controller.message.value.toString()}");
