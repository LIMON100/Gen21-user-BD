...
class ServicePayment2 extends StatefulWidget {
  String id;
  ServicePayment2({Key key, @required this.id}) : super(key: key);

  @override
  _ServicePayment2State createState() => _ServicePayment2State();
}


class _ServicePayment2State extends State<ServicePayment2> {
