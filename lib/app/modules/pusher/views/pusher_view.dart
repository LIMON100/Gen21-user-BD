...
//
//   @override
//   PusherViewState createState() => PusherViewState();
//
// }
//
// class PusherViewState  extends State<PusherView> {
//
//   GetStorage _box;
//   var myChannel;
...
//
//     _box.write('apiKey', _apiKey.text);
//     _box.write('cluster', _cluster.text);
//     _box.write('channelName', _channelName.text);
//
//
//     try {
//       await pusher.init(
...
//
//     _box.write('eventName',  _eventName.text);
//     _box.write('data',  _data.text);
//
...
//
//       _apiKey.text = _box.read("apiKey") ?? '';
//       _cluster.text = _box.read("cluster") ?? 'eu';
//       _channelName.text = _box.read("channelName") ?? 'presence-channel';
//       _eventName.text = _box.read("eventName") ?? 'client-event';
//       _data.text = _box.read("data") ?? 'test';
//     });
//
//   }
//
...
//                           scrollDirection: Axis.vertical,
//                           shrinkWrap: true,
//                           itemCount:  pusher.channels[_channelName.text]?.members != null ? pusher
//                               .channels[_channelName.text]?.members.length: 0,
