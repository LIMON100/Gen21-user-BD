...
import 'after_payment/AfterTipsPayment.dart';
import 'after_payment/DeclinePayment.dart';

import 'package:http/http.dart' as http;

class TipsPayment extends StatefulWidget {
  String id;
  String name;
  String email;
  String address;
  ...
  String coupon;
  String amount;
  TipsPayment({Key key, @required this.id, @required this.name, @required this.email, @required this.address, @required this.mobile, @required this.coupon, @required this.amount}) : super(key: key);

  @override
  _TipsPaymenttState createState() => _TipsPaymenttState();
}


class _TipsPaymenttState extends State<TipsPayment> {

  // final prc = ProviderRatingController();
  ...
  Future<String>fetchCardList()async{
    ...
    cards2 = cards;
    print("LENGTHLAST1;");
    print(uniqueCardNumbers.length);
    print(uniqueCardNumbers);
    // last4DigitsList = [];
  ...
  Future<void> onPressedButton() async {
    ...
    String amountAsString = amountInt.toString();
    ...
    bool responseFromPayment = await _laravelApiClient.payTips(widget.id, amountAsString, data1, data2, data3, selectedMonth, selectedYear);
  ...
  Future<void> onPressedButtonSelectCard() async {
    ...
    bool responseFromPayment = await _laravelApiClient.payTipsWithSelectCard(widget.id, amountAsString, cardId);
    Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    ...
    print("MMMM");
    print(_months.length);
    print(selectedY);
    double screenWidth = MediaQuery.of(context).size.width;
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Tips Payment"),
      ...
      body:isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            // Payable Amount
            SizedBox(height: 30),
            Center(child: Text("Tips Amount", style: TextStyle(fontSize: 20))),
