...
import '../../bookings/data/body/e_way_initiate_body.dart';
import '../../messages/controllers/messages_controller.dart';
import '../../tips/tip_controller.dart';
import '../../bookings/data/responses/eway_initeate_sesponse.dart' as eWayInitiateResponseRef;

class TipControllerNew extends GetxController {
  ...
  Future<void> initiateEway(BookingNew bookingNew) async {
    ...
    try {
      ...
      Customer customer = Customer(reference: "", title: "", firstName: '${name.first}', lastName: '${name.last}', companyName: "", jobDescription: "", street1: "${user.value.address}", street2: "", city: "", state: "", postalCode: "", country: "Au", mobile: "${user.value.phoneNumber}", phone: "${user.value.phoneNumber}", email: "${user.value.email}");
