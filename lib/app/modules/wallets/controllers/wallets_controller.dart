...
class WalletsController extends GetxController with WidgetsBindingObserver{
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    print("sdjnskjafs didChangeAppLifecycleState called");
    super.didChangeAppLifecycleState(state);
  }

  @override
  void onInit() async {
    print("sdjnskjafs WalletsController onInit() called");
