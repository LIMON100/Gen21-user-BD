          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  return Text(controller.isOpenedForEdit.value? "Edit the following details to update this wallet".tr : "Fill the following details to add new wallet".tr, style: Get.textTheme.caption).paddingSymmetric(horizontal: 22, vertical: 5);
