  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: new FloatingActionButton(
          ...
          onPressed: () => {Get.toNamed(Routes.WALLET_FORM).then((value) => controller.onInit())},
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (_, index) {
                            if (index == controller.wallets.length) {
                              return GestureDetector(
                                  onTap: () {
                                    ...
                                    Get.toNamed(Routes.WALLET_FORM).then((value) => controller.onInit());
                                  },
                            ...
                            return WalletBalanceCard(
                              ...
                              onEdit: (wallet) async {
                                await Get.toNamed(Routes.WALLET_FORM, arguments: {'wallet': wallet}).then((value) {
                                  controller.onInit();
                                });
                              },
                            );
