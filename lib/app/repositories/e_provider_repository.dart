...
class EProviderRepository {
  ...
  Future<Review> addProviderReview(Review review, EProvider eProvider, String bookingId) {
    return _laravelApiClient.addProviderReview(review, eProvider, bookingId);
  }

  // New Added
  Future<Review> addNewProviderReview(Review review, EProvider eProvider, String bookingId) {
    return _laravelApiClient.addProviderReview(review, eProvider, bookingId);
  }
}
