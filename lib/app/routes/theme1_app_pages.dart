...
import '../modules/cart/views/carts_view.dart';
...
import '../modules/checkout/views/payment_failed_view.dart';
...
import '../modules/e_provider/bindings/e_provider_binding_new.dart';
import '../modules/e_provider/views/e_provider_e_services_view.dart';
import '../modules/e_provider/views/e_provider_view.dart';
import '../modules/e_provider/views/e_provider_view_new.dart';
import '../modules/e_service/bindings/e_service_binding.dart';
import '../modules/e_service/bindings/service_binding.dart';
import '../modules/e_service/views/e_service_view.dart';
import '../modules/e_service/views/service_details_view.dart';
import '../modules/e_service/views/service_view.dart';
...
import '../modules/payment/bindings/e_way_binding.dart';
import '../modules/payment/views/e_way_view.dart';
import '../modules/profile/bindings/profile_binding.dart';
import '../modules/profile/views/profile_view.dart';
import '../modules/rating/bindings/rating_binding.dart';
import '../modules/rating/views/provider_rating_view.dart';
import '../modules/rating/views/rating_view.dart';
import '../modules/root/bindings/root_binding.dart';
import '../modules/root/views/root_view.dart';
import '../modules/search/views/search_view_backup.dart';
import '../modules/search/views/search_view.dart';
import '../modules/service_request/bindings/request_binding.dart';
import '../modules/service_request/bindings/service_request_binding.dart';
import '../modules/service_request/views/request_view.dart';
...
import '../modules/sub_service/bindings/sub_service_binding.dart';
import '../modules/sub_service/views/sub_service_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.PROVIDER_RATING, page: () => ProviderRatingView(), binding: RatingBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.E_WAY, page: () => EWayView(), binding: EWayBinding(), middlewares: [AuthMiddleware()]),
    ...
    GetPage(name: Routes.SERVICE, page: () => ServiceView(), binding: ServiceBinding(), transition: Transition.downToUp),
    GetPage(name: Routes.SERVICE_DETAILS, page: () => ServiceDetailsView(), binding: ServiceBinding(), transition: Transition.downToUp),
    GetPage(name: Routes.SUB_SERVICE, page: () => SubServiceView(), binding: SubServiceBinding(), transition: Transition.downToUp),

    GetPage(name: Routes.CART, page: () => CartsView(), binding: SubServiceBinding(), transition: Transition.downToUp),

    GetPage(name: Routes.SERVICE_REQUEST, page: () => RequestView(), binding: RequestBinding(), transition: Transition.downToUp),
    ...
    GetPage(name: Routes.PAYMENT_FAILED, page: () => PaymentFailedView(), binding: CheckoutBinding(), middlewares: [AuthMiddleware()]),
    ...
    GetPage(name: Routes.E_PROVIDER_NEW, page: () => EProviderViewNew(), binding: EProviderBindingNew()),
    ...
    GetPage(name: Routes.BOOKINGS, page: () => BookingsView(), binding: RootBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.BOOKINGS_NEW, page: () => BookingsViewNew(), binding: RootBinding(), middlewares: [AuthMiddleware()]),
