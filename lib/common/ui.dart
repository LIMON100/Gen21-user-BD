...
class Ui {
  ...
  static GetSnackBar NormalBar({String title = 'Location Warning', String message}) {
    Get.log("[$title] $message");
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6.merge(TextStyle(color: Get.theme.primaryColor))),
      messageText: Text(message, style: Get.textTheme.caption.merge(TextStyle(color: Get.theme.primaryColor))),
  ...
  static GetBar defaultSnackBar({String title = 'Alert', String message, SnackPosition snackPosition = SnackPosition.BOTTOM}) {
    Get.log("[$title] $message", isError: false);
    return GetBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6.merge(TextStyle(color: Get.theme.hintColor))),
      messageText: message != null ? Text(message, style: Get.textTheme.caption.merge(TextStyle(color: Get.theme.focusColor))): Container(),
  ...
  // static InputDecoration getCustomInputDecoration({String hintText = '', String errorText, IconData iconData, Widget suffixIcon, Widget suffix, double width , Color color}) {
  //   return InputDecoration(
  //     hintText: hintText,
  //     hintStyle: Get.textTheme.caption,
  //     prefixIcon: iconData != null ? Icon(iconData, color: Get.theme.focusColor).marginOnly(right: 14) : SizedBox(),
  ...
  //     focusedBorder: OutlineInputBorder(borderSide:  BorderSide(width: 1, color: Colors.yellow)),
  ...
  static Html applyHtml(String html, {TextStyle style, TextAlign textAlign, Alignment alignment = Alignment.centerLeft, double fontSize}) {
    return Html(
      ...
      customRender: {
        "p": (RenderContext context, Widget child) {
          return Text(
            ...
            textAlign: textAlign,
            style: style == null ? Get.textTheme.bodyText1.merge(TextStyle( fontSize: fontSize?? 11)) : style.merge(TextStyle(fontSize: fontSize?? 11)),
          );
        },
      },
      style: {
